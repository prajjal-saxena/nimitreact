  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#00cba9" fill-opacity="1" d="M0,96L40,106.7C80,117,160,139,240,128C320,117,400,75,480,58.7C560,43,640,53,720,74.7C800,96,880,128,960,128C1040,128,1120,96,1200,96C1280,96,1360,128,1400,144L1440,160L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>    <div class="container">
        <div class="we-dev sol-content">
            <div>
                <img src="img/mobiledev.png" alt=""/>            
            </div>
            <div>
                <h1>CREATIVE MOBILE DEVELOPMENT</h1>
                <p>The Mobile development professionals study the requirements and build the code. In the process, they optimize the business value of their client firms, offering alternative solutions. High-quality websites offer sophistication and aesthetic appeal, which have a deep impact on the thought process of customers.            </p>
                <p><i class="fa-ch fa fa-check-square-o" aria-hidden="true"></i><strong>Platform Friendly :</strong> A user-friendly App not only offers recognizable links—it uses links throughout its pages to help move visitors around to similar content. We provide the friendly platform for our clients.</p>
                <p><i class="fa-ch fa fa-check-square-o" aria-hidden="true"></i><strong>Interaction :</strong> A truly effective App design engages your visitors immediately and continues to hold their attention through EVERY page, as well as inﬂuences them to contact you. This is called 'conversion', and is probably your app's ultimate goal. We provide the interaction Mobile Apps.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container section-gap-bottom">
        ...
        <div class="web-content d-flex text-align">
            <div>
                ...
                <p>Combining cross-platform experience with our up-to-date knowledge of consumer trends, we design and build native, hybrid, and cross-platform mobile apps offering an intuitive user interfaces (UI) and rich user experiences (UX).</p>
            </div>
            <div>
                <h2>Reinvented Mobile Apps</h2>
                <p>Combining cross-platform experience with up-to-date knowledge of consumer trends, we’ll update your existing mobile app with the modern features and functions you need to increase engagement and retention.</p>
            </div>
        </div>
    </div>
   <div class="container section-gap-bottom">
      <div class="app-devlop up-down">
        <img src="img/app-dev.png" alt="">
      </div>
   </div>
    <div class="container">
       <div class="afford">
          <div>
             ...
             <h2>Maintenance Of Mobile Development</h2>
             ...
             <p><i class="fa-ch fa fa-check-square-o" aria-hidden="true"></i>Full Backup copy of your app.</p>
          </div>
          <div>
          ...
          <div>
             ...
             <h2>Keep Your App up-to-date</h2>
